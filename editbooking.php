...
<body>
    ...
    <?php endif ?>
<h2 style="text-align: center; background-color: rgba(23, 46, 23, 0.612); color: black; padding: 30px; margin-left:38%; width:fit-content; display:inline-block; border-radius:15px">Edit Booking Orders !</h2>
      <table>
	        <thead>                                 
		       <tr>                              
			      <th>Your Name</th>                        
